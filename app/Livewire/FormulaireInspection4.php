...
class FormulaireInspection4 extends Component
{
    ...
    public function mount($champId, $inspectionId)
    {
        ...
        // Rechercher l'inspection par 'plan_mission_code' au lieu de l'ID
        $this->inspection = Inspection::with([
            ...
            'idUsers4',
            'champsInspection'
        ])->where('plan_mission_code', $inspectionId)->firstOrFail();
