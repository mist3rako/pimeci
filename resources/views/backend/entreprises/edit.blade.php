...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Modifier une Entreprise</h6>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="code_entreprise" name="code_entreprise" value="{{ $entreprise->code_entreprise }}" placeholder="Entrez le code de l'entreprise" required>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="nom_entreprise" name="nom_entreprise" value="{{ $entreprise->nom_entreprise }}" placeholder="Entrez le nom de l'entreprise" required>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control" id="secteur_activite" name="secteur_activite" required>
                                            ...
                                            @foreach($secteurs as $secteur)
                                                <option value="{{ $secteur->id }}" {{ $secteur->id == $entreprise->secteur_activite_id ? 'selected' : '' }}>{{ $secteur->nom_secteur }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control" id="departement" name="departement" required>
                                            ...
                                            @foreach($adresses->unique('departement') as $adresse)
                                                <option value="{{ $adresse->departement }}" {{ $adresse->departement == $entreprise->adresse->departement ? 'selected' : '' }}>{{ $adresse->departement }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    @error('departement')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control" id="commune" name="commune" required>
                                            <option value="{{ $entreprise->adresse->commune }}">{{ $entreprise->adresse->commune }}</option>
                                        </select>
                                    </div>
                                    @error('commune')
                                        <span class="text-danger">{{ $message }}</span>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="code_postal" name="code_postal" value="{{ $entreprise->adresse->code_postal }}" readonly>
                                    </div>
                                    @error('code_postal')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="rue" name="rue" value="{{ $entreprise->rue }}" placeholder="Ex: 8, Rue Rigaud">
                                    </div>
                                    @error('rue')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
