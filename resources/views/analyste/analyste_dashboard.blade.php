...
<html lang="en">
	<!--begin::Head-->
	<head><base href="">
		<title>Analyste Dashboard Panel</title>
		...
		<meta property="og:url" content="MCI - Inspections" />
		<meta property="og:site_name" content="MCI - Inspections" />
		<link rel="canonical" href="https://preview.keenthemes.com/metronic8" />
		<link rel="shortcut icon" href="{{ asset('bckd/assets/media/logos/favicon.ico')}}" />
		<!--begin::Fonts-->
		<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700" />
		<!--end::Fonts-->
		<!--begin::Page Vendor Stylesheets(used by this page)-->
		<link href="{{ asset('bckd/assets/plugins/custom/leaflet/leaflet.bundle.css')}}" rel="stylesheet" type="text/css" />
		<!--end::Page Vendor Stylesheets-->
		<!--begin::Global Stylesheets Bundle(used by all pages)-->
		<link href="{{ asset('bckd/ssets/plugins/global/plugins.bundle.css')}}a" rel="stylesheet" type="text/css" />
		<link href="{{ asset('bckd/assets/css/style.bundle.css')}}" rel="stylesheet" type="text/css" />
					...
					<div class="header-mobile py-3">
						...
						<div class="container d-flex flex-stack">
							...
							<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
								<a href="">
									<img alt="Logo" src="{{ asset('bckd/assets/media/logos/logo-demo9.svg')}}" class="h-35px" />
								</a>
							</div>
							<!--end::Mobile logo-->
							<!--begin::Aside toggle-->
...
@include('analyste.body.topbar')
					<!--begin::Content-->
@yield('analyste')
					<!--end::Content-->
@include('analyste.body.footer')
				</div>
				<!--end::Wrapper-->
			</div>
			<!--end::Page-->
									...
									<div class="pe-3 mb-5">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Nina Nilson">
												<img src="{{ asset('bckd/assets/media/avatars/150-11.jpg')}}" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
									...
									<div class="overflow-auto pb-5">
										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">
											...
											<div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px pe-2">
												...
												<div class="symbol symbol-circle symbol-25px">
													<img src="{{ asset('bckd/assets/media/avatars/150-3.jpg')}}" alt="img" />
												</div>
												<!--end::User-->
												<!--begin::User-->
												<div class="symbol symbol-circle symbol-25px">
										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0">
											...
											<div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px">
												<!--begin::User-->
												<div class="symbol symbol-circle symbol-25px">
													<img src="{{ asset('bckd/assets/media/avatars/150-5.jpg')}}" alt="img" />
												</div>
												<!--end::User-->
												<!--begin::User-->
												<div class="symbol symbol-circle symbol-25px">
									...
									<div class="overflow-auto pe-3">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Alan Nilson">
												<img src="{{ asset('bckd/assets/media/avatars/150-2.jpg')}}" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
									...
									<div class="mb-5 pe-3">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Jan Hummer">
												<img src="{{ asset('bckd/assets/media/avatars/150-6.jpg')}}" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
									...
									<div class="overflow-auto pb-5">
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
											...
											<div class="d-flex flex-aligns-center">
												<!--begin::Icon-->
												<img alt="" class="w-30px me-3" src="{{ asset('bckd/assets/media/svg/files/css.svg')}}" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-bold">
													<!--begin::Desc-->
									...
									<div class="pe-3 mb-5">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Robert Rich">
												<img src="{{ asset('bckd/assets/media/avatars/150-14.jpg')}}" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
						...
						<div class="mb-0">
							...
							<div class="mb-7">
								<div class="d-flex flex-stack">
									<h3 class="mb-0">MCI</h3>
									<a href="#" class="fw-bold" target="_blank">Insp</a>
								</div>
							</div>
							<!--end::Header-->
							<!--begin::License-->
							...
							<div class="rounded border border-dashed border-gray-300 py-4 px-6 mb-5">
								<div class="d-flex flex-stack">
									...
									<div class="text-nowrap">
										<a href="#" class="btn btn-sm btn-success" target="_blank">Contact</a>
									</div>
								</div>
							</div>
							<!--end::License-->
							<!--begin::Purchase-->
							<a href="#" class="btn btn-primary mb-15 w-100">Buy Now</a>
							<!--end::Purchase-->
...
<script>
    function logout() {
        fetch("{{ route('analyste.logout') }}", {
            ...
            if (response.ok) {
                window.location.href = "{{ url('/analyste/login') }}";
            }
        });
    }
</script>

		<script>var hostUrl = "{{ asset('bckd/assets/')}}";</script>
		<!--begin::Javascript-->
		<!--begin::Global Javascript Bundle(used by all pages)-->
		<script src="{{ asset('bckd/assets/plugins/global/plugins.bundle.js')}}"></script>
		<script src="{{ asset('bckd/assets/js/scripts.bundle.js')}}"></script>
		<!--end::Global Javascript Bundle-->
		<!--begin::Page Vendors Javascript(used by this page)-->
		<script src="{{ asset('bckd/assets/plugins/custom/leaflet/leaflet.bundle.js')}}"></script>
		<!--end::Page Vendors Javascript-->
		<!--begin::Page Custom Javascript(used by this page)-->
		<script src="{{ asset('bckd/assets/js/custom/modals/select-location.js')}}"></script>
		<script src="{{ asset('bckd/assets/js/custom/widgets.js')}}"></script>
		<script src="{{ asset('bckd/assets/js/custom/apps/chat/chat.js')}}"></script>
		<script src="{{ asset('bckd/assets/js/custom/modals/create-app.js')}}"></script>
		<script src="{{ asset('bckd/assets/js/custom/modals/upgrade-plan.js')}}"></script>
