...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Lignes de langage personnalisées pour les validations
    |--------------------------------------------------------------------------
    |
    | Ici, vous pouvez spécifier des messages de validation personnalisés pour des attributs en utilisant la
    | convention "attribute.rule" pour nommer les lignes. Cela permet de spécifier rapidement une ligne de
    | langue personnalisée pour une règle d'attribut spécifique.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes de langage suivantes sont utilisées pour échanger des espaces réservés d'attributs
