$(function() {
  ...
  // Vérifiez si le graphique est présent sur la page
if (typeof enterpriseCounts !== 'undefined' && typeof dates !== 'undefined') {
  var options1 = {
      chart: {
          type: "line",
          height: 60,
      ...
      series: [{
          name: 'Entreprises',
          data: enterpriseCounts // Utiliser la variable globale
      }],
      xaxis: {
          type: 'datetime',
          categories: dates, // Utiliser la variable globale
      },
      stroke: {
          width: 2,
          curve: "smooth"
  ...
  new ApexCharts(document.querySelector("#totalEnterprisesChart"), options1).render();
}
...
if($('#usersChart').length) {
  var options2 = {
    ...
    series: [{
      name: 'Utilisateurs',
      data: userCounts // Utiliser les nouvelles données des utilisateurs
    }],
    xaxis: {
      type: 'datetime',
      categories: userDates, // Utiliser les nouvelles dates des utilisateurs
    },
  };
...
if($('#PlanificationChart').length) {
  var options3 = {
    ...
    series: [{
      name: 'Planifications',
      data: planificationCounts // Utiliser les données des planifications
    }],
    xaxis: {
      type: 'datetime',
      categories: planificationDates, // Utiliser les dates des planifications
    },
    stroke: {
      width: 2,
      curve: "smooth"
  ...
  new ApexCharts(document.querySelector("#PlanificationChart"), options3).render();
}
// Planification Chart - END
...
// Planifications Chart
if($('#inspectionCompleteChart').length) {
  var options4 = {
    chart: {
      type: "line",
      height: 400,
    ...
    series: [
      {
        name: 'Planifié',
        data: planifieCounts,
        color: '#007bff' // Bleu pour "Planifié"
      },
      {
        name: 'En cours',
        data: enCoursCounts,
        color: '#ffc107' // Jaune abricot pour "En cours"
      },
      {
        name: 'Complète',
        data: completeCounts,
        color: '#28a745' // Vert pour "Complète"
      },
      {
        name: 'Expiré',
        data: expireCounts,
  ...
  new ApexCharts(document.querySelector("#inspectionCompleteChart"), options4).render();
}
// Planifications Chart - END
